...
import { getSimulatorProfileById } from 'apiSdk/simulator-profiles';
import { SimulatorProfileInterface } from 'interfaces/simulator-profile';

function SimulatorProfileViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Simulator Profile Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Simulator Profile Details
                  </Text>
                </Box>
                {hasAccess('simulator_profile', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/simulator-profiles/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Profile Name" text={data?.profile_name} />
                ...
                {hasAccess('child', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Child"
                    text={
                      <Link as={NextLink} href={`/children/view/${data?.child?.id}`}>
