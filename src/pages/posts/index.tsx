...
type ColumnType = ColumnDef<PostInterface, unknown>;
...
export function PostListPage(props: PostListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<PostInterface>>(
  ...
  const handleView = (row: PostInterface) => {
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/posts/view/${record.id}`} passHref legacyBehavior>
                <Button
