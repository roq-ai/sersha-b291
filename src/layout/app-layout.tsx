...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Children', path: '/children', entity: 'child', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Posts', path: '/posts', entity: 'post', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Simulator Profiles',
      path: '/simulator-profiles',
